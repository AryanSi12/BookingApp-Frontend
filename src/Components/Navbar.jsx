...
const Navbar = () => {
  ...
  return (
    <nav className="w-full ml-0 md:ml-52 absolute top-0 left-0 z-20 bg-transparent px-4 md:px-6 py-4 md:py-5 flex justify-between items-center max-w-7xl mx-auto">
